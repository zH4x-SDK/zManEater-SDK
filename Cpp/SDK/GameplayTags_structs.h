...
struct FGameplayTagQuery
{
	...
	unsigned char                                      UnknownData_KGDD[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGameplayTagSource
{
	...
	unsigned char                                      UnknownData_QV1N[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_RAO5[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y3F3[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_QSY8[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FRestrictedGameplayTagTableRow : public FGameplayTagTableRow
{
	...
	unsigned char                                      UnknownData_TOPR[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)

...
struct FSynth1PatchCable
{
	...
	unsigned char                                      UnknownData_N7YH[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      UnknownData_P2K5[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1JBY[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectEnvelopeFollowerSettings
{
	...
	unsigned char                                      UnknownData_VJSF[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectEQBand
{
	...
	unsigned char                                      UnknownData_SLC4[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectFilterSettings
{
	...
	unsigned char                                      UnknownData_Q0IB[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSourceEffectMidSideSpreaderSettings
{
	...
	unsigned char                                      UnknownData_IAFC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UMZ8[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectPhaserSettings
{
	...
	unsigned char                                      UnknownData_8BVQ[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FSourceEffectSimpleDelaySettings
{
	...
	unsigned char                                      UnknownData_JIQH[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FSourceEffectStereoDelaySettings
{
	...
	unsigned char                                      UnknownData_6TPG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSubmixEffectFilterSettings
{
	...
	unsigned char                                      UnknownData_KENW[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTapDelayInfo
{
	...
	unsigned char                                      UnknownData_SQSS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSynthKnobStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_TC7G[0x7];                                     // 0x0231(0x0007) MISSED OFFSET (PADDING)
...
struct FSynthSlateStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_Q6UF[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FEpicSynth1Patch
{
	...
	unsigned char                                      UnknownData_THTR[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModularSynthPreset : public FTableRowBase
{
	...
	unsigned char                                      UnknownData_6Z0Q[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R5LH[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FCCL[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F3RK[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FDUN[0x1];                                     // 0x0057(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7H3R[0x1];                                     // 0x0063(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ITPV[0x2];                                     // 0x007A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9EAF[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NHK0[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C3N5[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_74SS[0x3];                                     // 0x00A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GG9Z[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_32YP[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XGTZ[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSourceEffectRingModulationSettings
{
	...
	unsigned char                                      UnknownData_P0L7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Frequency;                                                 // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FSubmixEffectConvolutionReverbSettings
{
	...
	unsigned char                                      UnknownData_5A3S[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZIGF[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FSynth2DSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_46G1[0x4];                                     // 0x02B4(0x0004) MISSED OFFSET (PADDING)

...
// BlueprintGeneratedClass BP_PlayerSharkFlesh_IR.BP_PlayerSharkFlesh_IR_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PlayerSharkFlesh_IR.BP_PlayerSharkFlesh_IR_C");
		return ptr;
	}

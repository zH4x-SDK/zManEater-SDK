...
struct FAkMainOutputSettings
{
	...
	unsigned char                                      UnknownData_O5G9[0x3];                                     // 0x0014(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_SXJ5[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_UDW1[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkSpatialAudioSettings
{
	...
	unsigned char                                      UnknownData_IR92[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LOV4[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_3Q9U[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommonInitializationSettingsWithSampleRate : public FAkCommonInitializationSettings
{
	...
	unsigned char                                      UnknownData_4QRO[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_ZDVL[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettingsWithSystemInitialization : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_7APM[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_K1IC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6LCX[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7CQF[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkAdvancedInitializationSettingsWithMultiCoreRendering : public FAkAdvancedInitializationSettings
{
	...
	unsigned char                                      UnknownData_RPTD[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FAkAndroidAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_MZ4L[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkHololensAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_VUDD[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0ER2[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JMZP[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FAkAudioSession
{
	...
	unsigned char                                      UnknownData_AJNJ[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_MW97[0x3];                                     // 0x0008(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAkExternalSourceInfo
{
	...
	unsigned char                                      UnknownData_NIGE[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SD8W[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfaceOverride
{
	...
	unsigned char                                      UnknownData_9BUI[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkPluginInfo
{
	...
	unsigned char                                      UnknownData_X3J9[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAkCommunicationSettingsWithCommSelection : public FAkCommunicationSettings
{
	...
	unsigned char                                      UnknownData_B2UQ[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_9TJS[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FAkPS4AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_BMCY[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkPS5AdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_WG3V[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FAkGeometrySurfacePropertiesToMap
{
	...
	unsigned char                                      UnknownData_7RMR[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAkPoly
{
	...
	unsigned char                                      UnknownData_QYTC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FAkWindowsAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_1PLA[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkWinGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	bool                                               GlobalFocus;                                               // 0x003C(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHeadMountedDisplayAudioDevice;                          // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3QTO[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (PADDING)
...
struct FAkXboxOneGDKAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	...
	unsigned char                                      UnknownData_PGEO[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXboxOneAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OMKX[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkXSXAdvancedInitializationSettings : public FAkAdvancedInitializationSettingsWithMultiCoreRendering
{
	uint16_t                                           MaximumNumberOfXMAVoices;                                  // 0x0038(0x0002) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                               UseHardwareCodecLowLatencyMode;                            // 0x003A(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_LW3Q[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (PADDING)
...
struct FAkAudioEventTrackKey
{
	...
	unsigned char                                      UnknownData_GC7Q[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTangentDataSerializationHelper
{
	...
	unsigned char                                      UnknownData_5C02[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatValueSerializationHelper
{
	...
	unsigned char                                      UnknownData_6PY2[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneFloatChannelSerializationHelper
{
	...
	unsigned char                                      UnknownData_8V1P[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SB30[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)

...
// BlueprintGeneratedClass BP_Base_BarrelRaftEmpty.BP_Base_BarrelRaftEmpty_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_BarrelRaftEmpty.BP_Base_BarrelRaftEmpty_C");
		return ptr;
	}

...
struct FInterpCurvePointVector
{
	...
	unsigned char                                      UnknownData_NGSP[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector
{
	...
	unsigned char                                      UnknownData_BH8O[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	float                                              InVal;                                                     // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YC9B[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TU84[0xF];                                     // 0x0041(0x000F) MISSED OFFSET (PADDING)
...
struct FInterpCurveQuat
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_U0U0[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointTwoVectors
{
	...
	unsigned char                                      UnknownData_0LQ8[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveTwoVectors
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_N48D[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointLinearColor
{
	...
	unsigned char                                      UnknownData_U42V[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveLinearColor
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_P4TI[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FTransform
{
	...
	unsigned char                                      UnknownData_SJH7[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9TFS[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FDateTime
{
	unsigned char                                      UnknownData_9K6H[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FTimecode
{
	...
	unsigned char                                      UnknownData_GSPS[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FTimespan
{
	unsigned char                                      UnknownData_XYRC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CJU0[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FFloatRangeBound
{
	...
	unsigned char                                      UnknownData_2WO1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	TEnumAsByte<CoreUObject_ERangeBoundTypes>          Type;                                                      // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_UH35[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPolyglotTextData
{
	...
	unsigned char                                      UnknownData_441Y[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XOPK[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationEvent
{
	...
	unsigned char                                      UnknownData_X0R0[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAutomationExecutionEntry
{
	...
	unsigned char                                      UnknownData_TE98[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1WB6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FBox
{
	...
	unsigned char                                      UnknownData_01W8[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FBox2D
{
	...
	unsigned char                                      UnknownData_AF51[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurvePointFloat
{
	...
	unsigned char                                      UnknownData_BSS1[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveFloat
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_CUDA[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FInterpCurvePointVector2D
{
	...
	unsigned char                                      UnknownData_91L7[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FInterpCurveVector2D
{
	...
	bool                                               bIsLooped;                                                 // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PRU5[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              LoopKeyOffset;                                             // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

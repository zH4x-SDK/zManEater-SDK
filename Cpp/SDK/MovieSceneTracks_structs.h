...
struct FMovieScene3DAttachSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_JB2Y[0x2];                                     // 0x004E(0x0002) MISSED OFFSET (PADDING)
...
struct FMovieScene3DPathSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_BJD9[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z1Y1[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_G42M[0x18];                                    // 0x0030(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DScaleKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_Z7V1[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DRotationKeyStruct : public FMovieSceneKeyStruct
{
	...
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_A5BU[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DLocationKeyStruct : public FMovieSceneKeyStruct
{
	struct FVector                                     Location;                                                  // 0x0008(0x000C) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                                Time;                                                      // 0x0014(0x0004) (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_8I4I[0x18];                                    // 0x0018(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieScene3DTransformTemplateData
{
	...
	unsigned char                                      UnknownData_C7I1[0x3];                                     // 0x0641(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D5UO[0x7];                                     // 0x0649(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneActorReferenceData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_GW6G[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YM3T[0x60];                                    // 0x0050(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionData
{
	...
	unsigned char                                      UnknownData_AVIH[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O988[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraShakeSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	unsigned char                                      UnknownData_700D[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionData
{
	...
	unsigned char                                      UnknownData_OR46[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraAnimSectionTemplate : public FMovieSceneAdditiveCameraAnimationTemplate
{
	...
	struct FFrameNumber                                SectionStartTime;                                          // 0x0040(0x0004) (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_SV8M[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneCameraCutSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_THPA[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LFLA[0xE];                                     // 0x0072(0x000E) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorKeyStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_69IT[0x1C];                                    // 0x001C(0x001C) MISSED OFFSET (PADDING)
...
struct FMovieSceneColorSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_LA0O[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventTemplateBase : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_UEZB[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZLL2[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventSectionData : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_7UUN[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneFadeSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_JTSK[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneLevelVisibilitySectionTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_6UC6[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneComponentMaterialSectionTemplate : public FMovieSceneParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_D1QU[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieScenePrimitiveMaterialTemplate : public FMovieSceneEvalTemplate
{
	...
	unsigned char                                      UnknownData_1XGV[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_VCGZ[0x3];                                     // 0x02CD(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneStringChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_AEVJ[0x67];                                    // 0x0039(0x0067) MISSED OFFSET (PADDING)
...
struct FMovieSceneIntegerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_SLWU[0x7];                                     // 0x00D9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_64PE[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (PADDING)
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	unsigned char                                      UnknownData_KARM[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_602U[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5TPW[0x2];                                     // 0x00CA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7D5R[0x4];                                     // 0x00D4(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneVectorKeyStructBase : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_4DVL[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OHKJ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneVectorKeyStruct : public FMovieSceneVectorKeyStructBase
{
	...
	unsigned char                                      UnknownData_UVWK[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneEventChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_42GX[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)

...
struct FGeomComponentCacheParameters
{
	...
	unsigned char                                      UnknownData_C4OX[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LW67[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W2MC[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QXKG[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6Q08[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YP3Q[0x2];                                     // 0x003E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WIPI[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FChaosCollisionEventData
{
	...
	unsigned char                                      UnknownData_RCG2[0x14];                                    // 0x0044(0x0014) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionDebugDrawActorSelectedRigidBody
{
	...
	unsigned char                                      UnknownData_UFGP[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_LCJG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FChaosCollisionEventRequestSettings
{
	...
	unsigned char                                      UnknownData_5CVR[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosBreakingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_H5EL[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FChaosTrailingEventRequestSettings
{
	...
	unsigned char                                      UnknownData_57BQ[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FGeometryCollectionSizeSpecificData
{
	...
	unsigned char                                      UnknownData_5DNS[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

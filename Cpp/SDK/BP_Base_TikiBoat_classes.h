...
// BlueprintGeneratedClass BP_Base_TikiBoat.BP_Base_TikiBoat_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_TikiBoat.BP_Base_TikiBoat_C");
		return ptr;
	}

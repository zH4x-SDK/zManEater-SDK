...
// BlueprintGeneratedClass BP_Base_PaddleBoat.BP_Base_PaddleBoat_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_PaddleBoat.BP_Base_PaddleBoat_C");
		return ptr;
	}

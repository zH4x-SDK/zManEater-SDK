...
// BlueprintGeneratedClass GA_EVO_Shadow_Body_Aura_T1.GA_EVO_Shadow_Body_Aura_T1_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GA_EVO_Shadow_Body_Aura_T1.GA_EVO_Shadow_Body_Aura_T1_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GA_EVO_Shadow_Body_Aura_T1(int EntryPoint);
};

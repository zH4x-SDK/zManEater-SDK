...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_GreatWhite_BP.AIController_GreatWhite_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_GreatWhite_BP(int EntryPoint);
};

...
struct FNiagaraTypeDefinition
{
	...
	unsigned char                                      UnknownData_BSGW[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraVariableWithOffset : public FNiagaraVariableBase
{
	...
	unsigned char                                      UnknownData_SU2E[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H68K[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K0FD[0x68];                                    // 0x0050(0x0068) MISSED OFFSET (PADDING)
...
struct FNCPoolElement
{
	...
	unsigned char                                      UnknownData_WAXT[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FNCPool
{
	...
	unsigned char                                      UnknownData_6VXW[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraPlatformSet
{
	...
	unsigned char                                      UnknownData_2N76[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0OQO[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_1KYC[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_MTRI[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetID
{
	...
	unsigned char                                      UnknownData_HLGU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraDataSetCompiledData
{
	...
	unsigned char                                      UnknownData_AYWV[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VPBT[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEventGeneratorProperties
{
	...
	unsigned char                                      UnknownData_NUV3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraEmitterScalabilityOverride : public FNiagaraEmitterScalabilitySettings
{
	...
	unsigned char                                      UnknownData_7S6V[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEventScriptProperties : public FNiagaraEmitterScriptProperties
{
	...
	unsigned char                                      UnknownData_ORF1[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0041[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XF06[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptExecutionParameterStore : public FNiagaraParameterStore
{
	...
	unsigned char                                      UnknownData_LPOP[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraVMExecutableDataId
{
	...
	unsigned char                                      UnknownData_I112[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S0UG[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVariableMetaData
{
	...
	unsigned char                                      UnknownData_08ET[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VFJA[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HXWQ[0x3];                                     // 0x00C8(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_FCHD[0x3];                                     // 0x00CD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AOSX[0x2];                                     // 0x00D6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NUI4[0x6];                                     // 0x00E2(0x0006) MISSED OFFSET (PADDING)
...
struct FNiagaraParameterScopeInfo
{
	...
	unsigned char                                      UnknownData_0K7U[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_S0EW[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_CKXD[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NVPI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FNiagaraVariant
{
	...
	unsigned char                                      UnknownData_1WGJ[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData_0O79[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5GVF[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraSystemTrackImplementation : public FMovieSceneTrackImplementation
{
	...
	unsigned char                                      UnknownData_TXPY[0x3];                                     // 0x0018(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_YDMU[0x3];                                     // 0x001C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_S7ST[0x3];                                     // 0x0020(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_G38N[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneNiagaraVectorParameterSectionTemplate : public FMovieSceneNiagaraParameterSectionTemplate
{
	...
	unsigned char                                      UnknownData_EF5S[0x4];                                     // 0x02CC(0x0004) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemUpdateContext
{
	...
	unsigned char                                      UnknownData_GN2E[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FVMExternalFunctionBindingInfo
{
	...
	unsigned char                                      UnknownData_AV31[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraScriptDataInterfaceCompileInfo
{
	...
	unsigned char                                      UnknownData_R2WV[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AA6H[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraScriptDataInterfaceInfo
{
	...
	unsigned char                                      UnknownData_6YXS[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraFunctionSignature
{
	...
	unsigned char                                      UnknownData_O0H3[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraDataSetProperties
{
	...
	unsigned char                                      UnknownData_MO6S[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraGraphViewSettings
{
	...
	unsigned char                                      UnknownData_ALSC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FNiagaraSystemScalabilityOverride : public FNiagaraSystemScalabilitySettings
{
	...
	unsigned char                                      UnknownData_VPMX[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FNiagaraEmitterHandle
{
	...
	unsigned char                                      UnknownData_LC19[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_11J4[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraScalabilityManager
{
	...
	unsigned char                                      UnknownData_PHYN[0x28];                                    // 0x0018(0x0028) MISSED OFFSET (PADDING)
...
struct FSimulationStageMetaData
{
	...
	unsigned char                                      UnknownData_SDD5[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraVMExecutableData
{
	...
	unsigned char                                      UnknownData_5USY[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4RKH[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraModuleDependency
{
	...
	unsigned char                                      UnknownData_ZH7C[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_8DJY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UObject*>                             RootObjects;                                               // 0x0008(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_XPSX[0x68];                                    // 0x0018(0x0068) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_B6EE[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)

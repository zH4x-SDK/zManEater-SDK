...
struct FClothCollisionPrim_Convex
{
	...
	unsigned char                                      UnknownData_A5KR[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FClothCollisionPrim_Box
{
	...
	unsigned char                                      UnknownData_MSS4[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

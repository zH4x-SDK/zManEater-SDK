...
struct FChaosPhysicsCollisionInfo
{
	...
	unsigned char                                      UnknownData_SQ1U[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MCBD[0x40];                                    // 0x0000(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TGLD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

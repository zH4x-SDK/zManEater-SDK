...
struct FFocusEvent
{
	unsigned char                                      UnknownData_9UTD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IRTQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSlateColor
{
	...
	unsigned char                                      UnknownData_WCMK[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
struct FSlateBrush
{
	unsigned char                                      UnknownData_LQ5I[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CIMZ[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XVRT[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (PADDING)
...
struct FSlateSound
{
	...
	unsigned char                                      UnknownData_DM7D[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FFontOutlineSettings
{
	...
	unsigned char                                      UnknownData_ZWEK[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSlateFontInfo
{
	...
	unsigned char                                      UnknownData_W1EC[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4H6U[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FDockTabStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_AB0S[0x4];                                     // 0x06D4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInlineTextImageStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_G603[0x6];                                     // 0x0092(0x0006) MISSED OFFSET (PADDING)
...
struct FSliderStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_FJXK[0x4];                                     // 0x033C(0x0004) MISSED OFFSET (PADDING)
...
struct FSearchBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_E0GS[0x7];                                     // 0x0A79(0x0007) MISSED OFFSET (PADDING)
...
struct FExpandableAreaStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_1V57[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FCheckBoxStyle : public FSlateWidgetStyle
{
	...
	unsigned char                                      UnknownData_EMWH[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGeometry
{
	unsigned char                                      UnknownData_KOTO[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FInputEvent
{
	unsigned char                                      UnknownData_DOQH[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H0DT[0x58];                                    // 0x0018(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_13NO[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FFK3[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NSBD[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H0GC[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FFontData
{
	...
	unsigned char                                      UnknownData_CKL6[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCompositeFallbackFont
{
	...
	unsigned char                                      UnknownData_1HR3[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3QAI[0x30];                                    // 0x0018(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J8AB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)

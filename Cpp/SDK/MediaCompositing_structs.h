...
struct FMovieSceneMediaPlayerPropertySectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_PZX0[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneMediaSectionParams
{
	...
	unsigned char                                      UnknownData_BVG9[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

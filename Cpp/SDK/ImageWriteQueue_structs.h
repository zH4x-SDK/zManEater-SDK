...
struct FImageWriteOptions
{
	...
	unsigned char                                      UnknownData_G68C[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TQ0P[0x46];                                    // 0x001A(0x0046) MISSED OFFSET (PADDING)

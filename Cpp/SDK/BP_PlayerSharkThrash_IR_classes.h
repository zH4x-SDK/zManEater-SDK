...
// BlueprintGeneratedClass BP_PlayerSharkThrash_IR.BP_PlayerSharkThrash_IR_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PlayerSharkThrash_IR.BP_PlayerSharkThrash_IR_C");
		return ptr;
	}

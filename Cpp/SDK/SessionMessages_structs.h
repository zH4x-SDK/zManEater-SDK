...
{
	unsigned char                                      UnknownData_TX0J[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FSessionServiceLog
{
	...
	unsigned char                                      UnknownData_NDIH[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TT1Y[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FSessionServicePong
{
	...
	unsigned char                                      UnknownData_G8CD[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZLQB[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (PADDING)

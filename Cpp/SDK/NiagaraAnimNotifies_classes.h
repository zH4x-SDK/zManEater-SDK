...
public:
	...
	unsigned char                                      UnknownData_KNG9[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_J70O[0x1C];                                    // 0x0064(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_09H0[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_403M[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)

...
// BlueprintGeneratedClass BP_APEX_MED_Tail_IR.BP_APEX_MED_Tail_IR_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_APEX_MED_Tail_IR.BP_APEX_MED_Tail_IR_C");
		return ptr;
	}

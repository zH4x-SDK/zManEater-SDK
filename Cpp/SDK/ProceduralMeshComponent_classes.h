...
{
public:
	unsigned char                                      UnknownData_256H[0x8];                                     // 0x0438(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_V3VS[0x6];                                     // 0x0442(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4GKE[0x4];                                     // 0x048C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

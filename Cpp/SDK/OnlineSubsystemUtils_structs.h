...
{
	unsigned char                                      UnknownData_VW6E[0x108];                                   // 0x0000(0x0108) MISSED OFFSET (PADDING)
...
struct FOnlineProxyStoreOffer
{
	...
	unsigned char                                      UnknownData_CG2K[0x4];                                     // 0x0074(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5I8H[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2W0R[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductInfo2
{
	...
	unsigned char                                      UnknownData_9SC3[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInAppPurchaseProductRequest2
{
	...
	unsigned char                                      UnknownData_WHYM[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FPlayerReservation
{
	...
	unsigned char                                      UnknownData_GYMA[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPartyReservation
{
	...
	unsigned char                                      UnknownData_0J6A[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

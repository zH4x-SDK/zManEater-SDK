...
// BlueprintGeneratedClass FSH_Grouper_Base_BP.FSH_Grouper_Base_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FSH_Grouper_Base_BP.FSH_Grouper_Base_BP_C");
		return ptr;
	}

...
// BlueprintGeneratedClass BP_Base_TourAirboat_Empty.BP_Base_TourAirboat_Empty_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_TourAirboat_Empty.BP_Base_TourAirboat_Empty_C");
		return ptr;
	}

...
void UBP_Spear_IR_C::GetDirectImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactedSurface, bool bUnderwater, struct FImpactEffect* ImpactEffects)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Spear_IR.BP_Spear_IR_C.GetDirectImpactEffects");

	UBP_Spear_IR_C_GetDirectImpactEffects_Params params;

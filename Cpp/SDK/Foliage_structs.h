...
struct FProceduralFoliageInstance
{
	...
	unsigned char                                      UnknownData_9ZLW[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6CRU[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3D8A[0x20];                                    // 0x0040(0x0020) MISSED OFFSET (PADDING)
...
struct FFoliageTypeObject
{
	...
	unsigned char                                      UnknownData_H94X[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFoliageVertexColorChannelMask
{
	...
	unsigned char                                      UnknownData_SZO6[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9T4K[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)

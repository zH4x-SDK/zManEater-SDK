...
void UBP_Base_IR_C::GetDirectImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactedSurface, bool bUnderwater, struct FImpactEffect* ImpactEffects)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Base_IR.BP_Base_IR_C.GetDirectImpactEffects");

	UBP_Base_IR_C_GetDirectImpactEffects_Params params;
...
void UBP_Base_IR_C::GetScrapeEffects(TEnumAsByte<Engine_EPhysicalSurface> ScrapedSurface, struct FImpactEffect* ScrapeEffects)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Base_IR.BP_Base_IR_C.GetScrapeEffects");

	UBP_Base_IR_C_GetScrapeEffects_Params params;
...
struct FImpactEffect UBP_Base_IR_C::GetImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactingSurface, bool bUnderwater, bool bScrape)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Base_IR.BP_Base_IR_C.GetImpactEffects");

	UBP_Base_IR_C_GetImpactEffects_Params params;

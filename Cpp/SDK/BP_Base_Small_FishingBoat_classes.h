...
// BlueprintGeneratedClass BP_Base_Small_FishingBoat.BP_Base_Small_FishingBoat_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_Small_FishingBoat.BP_Base_Small_FishingBoat_C");
		return ptr;
	}

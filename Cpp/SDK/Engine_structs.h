...
enum class Engine_ETranslucentSortPolicy : uint8_t
{
	...
	ETranslucentSortPolicy__SortWithSeaLevel = 3,
	ETranslucentSortPolicy__ETranslucentSortPolicy_MAX = 4,
...
// Enum Engine.EStreamingDistancePreset
enum class Engine_EStreamingDistancePreset : uint8_t
{
	SDP_MediumSizedObjects         = 0,
	SDP_LargeSizedObjects          = 1,
	SDP_MAX                        = 2,
...
{
	unsigned char                                      UnknownData_V7AB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OAHR[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I6EY[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_L14N[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FRepAttachment
{
	...
	unsigned char                                      UnknownData_D1DS[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_GGFD[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FStreamingLevelsToConsider
{
	...
	unsigned char                                      UnknownData_32MZ[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OYPR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPSCPoolElem
{
	...
	unsigned char                                      UnknownData_L6KR[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FPSCPool
{
	...
	unsigned char                                      UnknownData_V1CK[0x8];                                     // 0x0030(0x0008) MISSED OFFSET (PADDING)
...
struct FWorldPSCPool
{
	...
	unsigned char                                      UnknownData_CZ7Z[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FResponseChannel
{
	...
	unsigned char                                      UnknownData_WBS2[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FWalkableSlopeOverride
{
	...
	unsigned char                                      UnknownData_YQTC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XQ01[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y7HA[0x6];                                     // 0x0000(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2OOD[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CAWF[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPNO : 1;                                      // 0x000C(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_GLZX : 2;                                      // 0x000E(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_HFHZ[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPDB[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UOO0[0x8];                                     // 0x0060(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I0L1[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4TGJ[0x40];                                    // 0x00D0(0x0040) MISSED OFFSET (PADDING)
...
struct FSkelMeshComponentLODInfo
{
	...
	unsigned char                                      UnknownData_KP1Q[0x18];                                    // 0x0010(0x0018) MISSED OFFSET (PADDING)
...
struct FMeshUVChannelInfo
{
	...
	unsigned char                                      UnknownData_OPSE[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMaterial
{
	...
	unsigned char                                      UnknownData_UI0V[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FBoneMirrorInfo
{
	...
	unsigned char                                      UnknownData_XCW2[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_OHJ0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_6SG5[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0GWM[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GXY7[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6MOU[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneReference
{
	...
	unsigned char                                      UnknownData_CINY[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshLODInfo
{
	...
	unsigned char                                      UnknownData_CYGI[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HG64[0x6];                                     // 0x00B2(0x0006) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegionBoneFilter
{
	...
	unsigned char                                      UnknownData_ZEJS[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshSamplingRegion
{
	...
	unsigned char                                      UnknownData_SMXX[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_WWCM[0x48];                                    // 0x0000(0x0048) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_LX3D[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FSkinWeightProfileInfo
{
	...
	unsigned char                                      UnknownData_9Z9P[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_E9ND[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K29A[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDebugTextInfo
{
	...
	unsigned char                                      UnknownData_R6X4[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BKQV[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1A0D[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
struct FSingleAnimationPlayData
{
	...
	unsigned char                                      UnknownData_P1AC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_N3UZ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_22RC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_OLTD[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_UONQ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4E6P[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyEvent : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_RPTU[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ON5S[0x2];                                     // 0x0092(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4RSU[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K243[0x2];                                     // 0x00A2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	int                                                TrackIndex;                                                // 0x00A4(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_KXL1[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownData_HKDC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XTBO[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_L1PL[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M5IJ[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRealCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_3CMV[0x2];                                     // 0x006E(0x0002) MISSED OFFSET (PADDING)
...
struct FRichCurveKey
{
	...
	unsigned char                                      UnknownData_25GE[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_M78G[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TQGA[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YS7H[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAttenuationSubmixSendSettings
{
	...
	unsigned char                                      UnknownData_KHC6[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundAttenuationSettings : public FBaseAttenuationSettings
{
	...
	unsigned char                                      UnknownData_08SA[0x1];                                     // 0x00B3(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9GA4[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B3QF[0x4];                                     // 0x02E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_P1IX[0x17];                                    // 0x0001(0x0017) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FChannelDefinition
{
	...
	unsigned char                                      UnknownData_5HY4[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FBasedMovementInfo
{
	...
	unsigned char                                      UnknownData_JUT3[0x5];                                     // 0x002B(0x0005) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9UMY[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R61V[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionMovementParams
{
	...
	unsigned char                                      UnknownData_ORB7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GKBA[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRepRootMotionMontage
{
	...
	unsigned char                                      UnknownData_LPDA[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IKGO[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SEJB[0x6];                                     // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSimulatedRootMotionReplicatedMove
{
	...
	unsigned char                                      UnknownData_OH0S[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHitResult
{
	...
	unsigned char                                      UnknownData_6BEF[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFindFloorResult
{
	...
	unsigned char                                      UnknownData_TAB4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_E7JX[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SGSA[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
struct FLightmassPrimitiveSettings
{
	...
	unsigned char                                      UnknownData_Z47I[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FWeightedBlendable
{
	...
	unsigned char                                      UnknownData_WDNN[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPostProcessSettings
{
	...
	unsigned char                                      UnknownData_LN9K[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1UPT[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      bOverride_EnableOutlines : 1;                              // 0x0018(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_F8EA[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WVXU[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      bEnableOutlines : 1;                                       // 0x0020(0x0001) BIT_FIELD (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_X4CX[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HXGG[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MGWU[0x3];                                     // 0x0315(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O9I8[0x7];                                     // 0x0319(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SKFY[0x3];                                     // 0x0411(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H38L[0x3];                                     // 0x043D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L9GJ[0x3];                                     // 0x0459(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z73M[0x3];                                     // 0x04E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CNJL[0x1];                                     // 0x0507(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V3OW[0x2];                                     // 0x0516(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8EXW[0x4];                                     // 0x052C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FActiveForceFeedbackEffect
{
	...
	unsigned char                                      UnknownData_DW08[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FStatColorMapping
{
	...
	unsigned char                                      UnknownData_GKHY[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FClassRedirect
{
	...
	unsigned char                                      UnknownData_SWHR[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
struct FCachedKeyToActionInfo
{
	...
	unsigned char                                      UnknownData_XER1[0x68];                                    // 0x0008(0x0068) MISSED OFFSET (PADDING)
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownData_RP80[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_W6KA[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CZNT[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FTireFrictionScalePair
{
	...
	unsigned char                                      UnknownData_7C8H[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
struct FMinimalViewInfo
{
	...
	unsigned char                                      UnknownData_AXKX[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EOND[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VR6W[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6WV7[0x48];                                    // 0x0588(0x0048) MISSED OFFSET (PADDING)
...
struct FCameraCacheEntry
{
	...
	unsigned char                                      UnknownData_XYS2[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTViewTarget
{
	...
	unsigned char                                      UnknownData_IBAW[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OAWH[0x8];                                     // 0x05E8(0x0008) MISSED OFFSET (PADDING)
...
struct FEngineShowFlagsSetting
{
	...
	unsigned char                                      UnknownData_4WI2[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FDebugDisplayProperty
{
	...
	unsigned char                                      UnknownData_2BX3[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FReverbSettings
{
	...
	unsigned char                                      UnknownData_JHA7[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInteriorSettings
{
	...
	unsigned char                                      UnknownData_3UJ3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBroadphaseSettings
{
	...
	unsigned char                                      UnknownData_PADB[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLightmassMaterialInterfaceSettings
{
	...
	unsigned char                                      UnknownData_YOW0[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialParameterInfo
{
	...
	unsigned char                                      UnknownData_IK58[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontParameterValue
{
	...
	unsigned char                                      UnknownData_4BX7[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_YMU4[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       ExpressionGUID;                                            // 0x0014(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FStaticSwitchParameter : public FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_5D1F[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FStaticTerrainLayerWeightParameter : public FStaticParameterBase
{
	...
	unsigned char                                      UnknownData_CNY8[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9RNL[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintComponentChangedPropertyInfo
{
	...
	unsigned char                                      UnknownData_SBOH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintCookedComponentInstancingData
{
	...
	unsigned char                                      UnknownData_FFDO[0x11];                                    // 0x0010(0x0011) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_K6LB[0x26];                                    // 0x0022(0x0026) MISSED OFFSET (PADDING)
...
struct FSoundConcurrencySettings
{
	...
	unsigned char                                      UnknownData_KWTQ[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1RKO[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G44Y[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSubmixSendInfo
{
	...
	unsigned char                                      UnknownData_ZPPZ[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NPR5[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundSourceBusSendInfo
{
	...
	unsigned char                                      UnknownData_0PK6[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	float                                              MinSendDistance;                                           // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                              MaxSendDistance;                                           // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_FGSR[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRuntimeFloatCurve                          CustomSendLevelCurve;                                      // 0x0028(0x0088) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
struct FSoundWaveSpectralTimeData
{
	...
	unsigned char                                      UnknownData_S780[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSubtitleCue
{
	...
	unsigned char                                      UnknownData_LCMY[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FInterpolationParameter
{
	...
	unsigned char                                      UnknownData_E7GZ[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FBlendParameter
{
	...
	unsigned char                                      UnknownData_99IU[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FBakedStateExitTransition
{
	...
	unsigned char                                      UnknownData_ARJX[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBakedAnimationState
{
	...
	unsigned char                                      UnknownData_W4ES[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TZJU[0x7];                                     // 0x0051(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionBetweenStates : public FAnimationStateBase
{
	...
	unsigned char                                      UnknownData_RMY2[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2JBK[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FBakedAnimationStateMachine
{
	...
	unsigned char                                      UnknownData_Z0FR[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FExposedValueCopyRecord
{
	...
	unsigned char                                      UnknownData_00AB[0x1];                                     // 0x0017(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FExposedValueHandler
{
	...
	unsigned char                                      UnknownData_GE8B[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimBlueprintFunction
{
	...
	unsigned char                                      UnknownData_DFH7[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CL56[0x28];                                    // 0x0038(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_M06M[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FSmartName
{
	...
	unsigned char                                      UnknownData_N25I[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimSegment
{
	...
	unsigned char                                      UnknownData_UXXL[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMarkerSyncData
{
	...
	unsigned char                                      UnknownData_DTQB[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FCompositeSection : public FAnimLinkableElement
{
	...
	unsigned char                                      UnknownData_JIYN[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBranchingPointMarker
{
	...
	unsigned char                                      UnknownData_QG58[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurve
{
	...
	unsigned char                                      UnknownData_7OLX[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetRules
{
	...
	unsigned char                                      UnknownData_HPV3[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FPrimaryAssetTypeInfo
{
	...
	unsigned char                                      UnknownData_PLVX[0x6];                                     // 0x003A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A7AC[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GYBT[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPrimaryAssetRulesCustomOverride
{
	...
	unsigned char                                      UnknownData_Q1BW[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FAudioQualitySettings
{
	...
	unsigned char                                      UnknownData_FUAV[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FEditorMapPerformanceTestDefinition
{
	...
	unsigned char                                      UnknownData_XQD2[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FEditorImportExportTestDefinition
{
	...
	unsigned char                                      UnknownData_GRKF[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBandwidthTestGenerator
{
	...
	unsigned char                                      UnknownData_ZKXK[0x10];                                    // 0x0010(0x0010) MISSED OFFSET (PADDING)
...
struct FBoneNode
{
	...
	unsigned char                                      UnknownData_W630[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G2TA[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FFOscillator
{
	...
	unsigned char                                      UnknownData_Q27B[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FCollisionResponseTemplate
{
	...
	unsigned char                                      UnknownData_XIA0[0x1];                                     // 0x0009(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YHSR[0x21];                                    // 0x000B(0x0021) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J0VP[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FLE8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B57N[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IRGI[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HHGI[0x28];                                    // 0x0010(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EZU6[0x60];                                    // 0x0040(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMulticastRecordOptions
{
	...
	unsigned char                                      UnknownData_5N0A[0x6];                                     // 0x0012(0x0006) MISSED OFFSET (PADDING)
...
struct FTextureLODGroup
{
	...
	unsigned char                                      UnknownData_951Z[0xB];                                     // 0x0001(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6KQ7[0x4];                                     // 0x0018(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WISY[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FXJ8[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E25M[0x2];                                     // 0x0052(0x0002) MISSED OFFSET (PADDING)
...
struct FLightmassLightSettings
{
	...
	unsigned char                                      UnknownData_NFGJ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FFontCharacter
{
	...
	unsigned char                                      UnknownData_GBWM[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontImportOptionsData
{
	...
	unsigned char                                      UnknownData_S3U5[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IM9K[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WGI4[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y7W8[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P94K[0x3];                                     // 0x0099(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NOFO[0x3];                                     // 0x00A1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RV00[0x4];                                     // 0x00AC(0x0004) MISSED OFFSET (PADDING)
...
struct FForceFeedbackChannelDetails
{
	...
	unsigned char                                      UnknownData_ESLF[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHLODProxyMesh
{
	...
	unsigned char                                      UnknownData_1G77[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_U3G9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintInputActionDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_JML6[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       FunctionNameToBind;                                        // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
	unsigned char                                      UnknownData_J33E[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_Y42D[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ONPW[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZE6M[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FInputAxisProperties
{
	...
	unsigned char                                      UnknownData_90N3[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FInputActionKeyMapping
{
	...
	unsigned char                                      UnknownData_3T8L[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInputAxisKeyMapping
{
	...
	unsigned char                                      UnknownData_FSDR[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FKey                                        Key;                                                       // 0x0010(0x0018) (Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FBlueprintInputTouchDelegateBinding : public FBlueprintInputDelegateBinding
{
	...
	unsigned char                                      UnknownData_0BGP[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCurveEdEntry
{
	...
	unsigned char                                      UnknownData_QIN5[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FInterpControlPoint
{
	...
	unsigned char                                      UnknownData_D0RJ[0xF];                                     // 0x000D(0x000F) MISSED OFFSET (PADDING)
...
struct FAnimControlTrackKey
{
	...
	unsigned char                                      UnknownData_ZVDS[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1C2X[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FBoolTrackKey
{
	...
	unsigned char                                      UnknownData_DTND[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FVirtualTextureBuildSettings
{
	...
	unsigned char                                      UnknownData_D7Y7[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FSubsurfaceProfileStruct
{
	...
	unsigned char                                      UnknownData_9KJR[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTimelineVectorTrack
{
	...
	unsigned char                                      UnknownData_CSL6[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimelineFloatTrack
{
	...
	unsigned char                                      UnknownData_GOW6[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimelineLinearColorTrack
{
	...
	unsigned char                                      UnknownData_AVT4[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (PADDING)
...
struct FTimeline
{
	...
	unsigned char                                      UnknownData_03H9[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R8UC[0x18];                                    // 0x0080(0x0018) MISSED OFFSET (PADDING)
...
struct FTTTrackBase
{
	unsigned char                                      UnknownData_1HL8[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EH8R[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FMaterialProxySettings
{
	...
	unsigned char                                      UnknownData_12VS[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshMergingSettings
{
	...
	unsigned char                                      UnknownData_GZPU[0x1];                                     // 0x009F(0x0001) MISSED OFFSET (PADDING)
...
struct FHierarchicalSimplification
{
	...
	unsigned char                                      UnknownData_Z8UB[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDistributionLookupTable
{
	...
	unsigned char                                      UnknownData_05IS[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FFormatArgumentData
{
	...
	unsigned char                                      UnknownData_2415[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GTTK[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y96Q[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData_DKAZ[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TV65[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlatformInterfaceDelegateResult
{
	...
	unsigned char                                      UnknownData_F0G1[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDebugFloatHistory
{
	...
	unsigned char                                      UnknownData_UPXX[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FUserActivity
{
	...
	unsigned char                                      UnknownData_SVI3[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NZFG[0x54];                                    // 0x0000(0x0054) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PKN3[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q39J[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8WOX[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FInputScaleBiasClamp
{
	...
	unsigned char                                      UnknownData_MOFH[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RVUZ[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAlphaBlend
{
	...
	unsigned char                                      UnknownData_JDMY[0x18];                                    // 0x000C(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J2B6[0xB];                                     // 0x0025(0x000B) MISSED OFFSET (PADDING)
...
struct FInputAlphaBoolBlend
{
	...
	unsigned char                                      UnknownData_TES2[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPoseLinkBase
{
	...
	unsigned char                                      UnknownData_F1PT[0xC];                                     // 0x0004(0x000C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5XWY[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OUG3[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FQO5[0x6E0];                                   // 0x0000(0x06E0) MISSED OFFSET (PADDING)
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_7UB8[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YWE1[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FPoseSnapshot
{
	...
	unsigned char                                      UnknownData_RXET[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
{
	struct FName                                       Name;                                                      // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3F73[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AKK7[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_E513[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H75H[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FKShapeElem
{
	unsigned char                                      UnknownData_4ZCD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UQRQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_47DZ[0x17];                                    // 0x0019(0x0017) MISSED OFFSET (PADDING)
...
struct FKBoxElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_0J31[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKConvexElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_5I2Y[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0070(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_DPIS[0x10];                                    // 0x00A0(0x0010) MISSED OFFSET (PADDING)
...
struct FKTaperedCapsuleElem : public FKShapeElem
{
	...
	unsigned char                                      UnknownData_E00U[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
struct FKAggregateGeom
{
	...
	unsigned char                                      UnknownData_DMIP[0x8];                                     // 0x0050(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimationGroupReference
{
	...
	unsigned char                                      UnknownData_6Z2Q[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YOO9[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
struct FAnimTickRecord
{
	...
	unsigned char                                      UnknownData_76Z0[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
struct FBlendFilter
{
	unsigned char                                      UnknownData_M2H9[0x78];                                    // 0x0000(0x0078) MISSED OFFSET (PADDING)
...
struct FBlendSampleData
{
	...
	unsigned char                                      UnknownData_9BYU[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T48I[0x20];                                    // 0x0020(0x0020) MISSED OFFSET (PADDING)
...
struct FAnimationRecordingSettings
{
	...
	unsigned char                                      UnknownData_FPU6[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0NQV[0x2];                                     // 0x000E(0x0002) MISSED OFFSET (PADDING)
...
struct FNamedTransform
{
	...
	unsigned char                                      UnknownData_UCO5[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6V4U[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KIPT[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7BS7[0xB0];                                    // 0x0000(0x00B0) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2DP2[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J5GE[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FSlotEvaluationPose
{
	...
	unsigned char                                      UnknownData_7EP9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Weight;                                                    // 0x0004(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_70HZ[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ILIG[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FQueuedDrawDebugItem
{
	...
	unsigned char                                      UnknownData_JARV[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IAVS[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimMontageInstance
{
	...
	unsigned char                                      UnknownData_8BJ5[0x20];                                    // 0x0008(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	bool                                               bPlaying;                                                  // 0x0028(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_GPUP[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4AOA[0xB8];                                    // 0x0030(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LRHJ[0x10];                                    // 0x0108(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WVDP[0x28];                                    // 0x0160(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3S2Q[0x24];                                    // 0x018C(0x0024) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyMeshSpaceAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_RXUV[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PVU3[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XFJA[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CustomProperty : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_7JGP[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
struct FAnimNode_Inertialization : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_J3T8[0x50];                                    // 0x0020(0x0050) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9Q7G[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1IDN[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BSRF[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7YV2[0x90];                                    // 0x0000(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_LinkedAnimGraph : public FAnimNode_CustomProperty
{
	...
	unsigned char                                      UnknownData_F34U[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C6JI[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_LinkedInputPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_BRJM[0x48];                                    // 0x0030(0x0048) MISSED OFFSET (PADDING)
...
struct FAnimNode_SaveCachedPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_F9OE[0x90];                                    // 0x0028(0x0090) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_2TBC[0x3];                                     // 0x0075(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_FT40[0x96];                                    // 0x001A(0x0096) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R9GP[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_PZMT[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2V6M[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5570[0x38];                                    // 0x0010(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4W5F[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_REI5[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_TransitionResult : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_OR2I[0x17];                                    // 0x0011(0x0017) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3AD1[0x150];                                   // 0x06E0(0x0150) MISSED OFFSET (PADDING)
...
struct FAnimNode_SingleNode : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_OUJ1[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimationTransitionRule
{
	...
	unsigned char                                      UnknownData_47I3[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNotifyTrack
{
	...
	unsigned char                                      UnknownData_WRHF[0x20];                                    // 0x0018(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3JC4[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_M3E7[0xA8];                                    // 0x00A8(0x00A8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FWZB[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SQ7Z[0x40];                                    // 0x0008(0x0040) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NV0C[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
struct FEditedDocumentInfo
{
	...
	unsigned char                                      UnknownData_U8J1[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEdGraphTerminalType
{
	...
	unsigned char                                      UnknownData_8E5L[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (PADDING)
...
struct FEdGraphPinType
{
	...
	unsigned char                                      UnknownData_VSRZ[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (PADDING)
...
struct FBPVariableDescription
{
	...
	unsigned char                                      UnknownData_FO2N[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_5Z1M[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCompilerNativizationOptions
{
	...
	unsigned char                                      UnknownData_G82U[0x5];                                     // 0x000B(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEventGraphFastCallPair
{
	...
	unsigned char                                      UnknownData_WOYH[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AYOO[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G1OH[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VLM4[0x190];                                   // 0x0000(0x0190) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_I829[0x14];                                    // 0x0000(0x0014) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_I3O1[0x2];                                     // 0x0000(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_S3MS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X0YP[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FCachedAnimTransitionData
{
	...
	unsigned char                                      UnknownData_FLIG[0xC];                                     // 0x0018(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimRelevancyData
{
	...
	unsigned char                                      UnknownData_TAT8[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimAssetPlayerData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_DQEP[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateData
{
	struct FName                                       StateMachineName;                                          // 0x0000(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FName                                       StateName;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_EBT8[0xC];                                     // 0x0010(0x000C) MISSED OFFSET (PADDING)
...
struct FCachedAnimStateArray
{
	...
	unsigned char                                      UnknownData_762K[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T61Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FChildActorComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_QKHO[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
struct FAutoCompleteNode
{
	...
	unsigned char                                      UnknownData_G6AH[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        AutoCompleteListIndices;                                   // 0x0008(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ZOFP[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FConstraintDrive
{
	...
	unsigned char                                      UnknownData_L4SL[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FAngularDriveConstraint
{
	...
	unsigned char                                      UnknownData_ND4R[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearDriveConstraint
{
	...
	unsigned char                                      UnknownData_ZBE8[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_SMDC[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FLinearConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_1F3L[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FConeConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_FY5S[0x2];                                     // 0x001E(0x0002) MISSED OFFSET (PADDING)
...
struct FTwistConstraint : public FConstraintBaseParams
{
	...
	unsigned char                                      UnknownData_JVX5[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
struct FConstraintProfileProperties
{
	...
	unsigned char                                      UnknownData_PE4B[0x3];                                     // 0x0101(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z9HB[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KJDB[0x7];                                     // 0x0085(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FConstraintProfileProperties                ProfileInstance;                                           // 0x008C(0x0104) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NAMS[0x28];                                    // 0x0190(0x0028) MISSED OFFSET (PADDING)
...
struct FLevelNameAndTime
{
	...
	unsigned char                                      UnknownData_T2AF[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_54EO[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FScreenMessageString
{
	...
	unsigned char                                      UnknownData_46GP[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FFullyLoadedPackagesInfo
{
	...
	unsigned char                                      UnknownData_VIPZ[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelStreamingStatus
{
	...
	unsigned char                                      UnknownData_92Z9[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNamedNetDriver
{
	...
	unsigned char                                      UnknownData_H4BO[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Y0J6[0xD0];                                    // 0x0000(0x00D0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OZPO[0x10];                                    // 0x01B8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YRKU[0x18];                                    // 0x01D8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NRG0[0x50];                                    // 0x0230(0x0050) MISSED OFFSET (PADDING)

};

// ScriptStruct Engine.OverlapUpdateInfo
// 0x0010
struct FOverlapUpdateInfo
{
	bool                                               bDoNotifies;                                               // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OPLM[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	class USceneComponent*                             UpdateComponent;                                           // 0x0008(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FExposureSettings
{
	...
	unsigned char                                      UnknownData_O9I7[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_NIUZ[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FDepthFieldGlowInfo
{
	...
	unsigned char                                      UnknownData_TRAX[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFontRenderInfo
{
	...
	unsigned char                                      UnknownData_LUN0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FComponentReference
{
	...
	unsigned char                                      UnknownData_CHE6[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)
...
struct FDamageEvent
{
	unsigned char                                      UnknownData_4Q1O[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshBuildSettings
{
	...
	unsigned char                                      UnknownData_HMRO[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2WG8[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_941M[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_69VG[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KOR8[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOverlapResult
{
	...
	unsigned char                                      UnknownData_LCQR[0x4];                                     // 0x0010(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bBlockingHit : 1;                                          // 0x0014(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_IUZ2[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FPrimitiveMaterialRef
{
	...
	unsigned char                                      UnknownData_GEPM[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FSwarmDebugOptions
{
	...
	unsigned char                                      UnknownData_VER2[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassDebugOptions
{
	...
	unsigned char                                      UnknownData_A9X1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MNUG[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyContactInfo
{
	...
	unsigned char                                      UnknownData_OJEM[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRigidBodyState
{
	...
	unsigned char                                      UnknownData_PYF5[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ASIT[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)
...
struct FForceFeedbackParameters
{
	...
	unsigned char                                      UnknownData_AESH[0x1];                                     // 0x000B(0x0001) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathResult
{
	...
	unsigned char                                      UnknownData_UQ2G[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)
...
struct FPredictProjectilePathParams
{
	...
	unsigned char                                      UnknownData_NUKF[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q8QZ[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DJL1[0x3];                                     // 0x0051(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VJF8[0x7];                                     // 0x0059(0x0007) MISSED OFFSET (PADDING)
...
struct FActiveHapticFeedbackEffect
{
	...
	unsigned char                                      UnknownData_VYKU[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FImportanceTexture
{
	...
	unsigned char                                      UnknownData_NF9W[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G60J[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FInstancedStaticMeshComponentInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_VO3H[0x20];                                    // 0x0110(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6513[0xC];                                     // 0x0134(0x000C) MISSED OFFSET (PADDING)
...
struct FIntegralCurve : public FIndexedCurve
{
	...
	unsigned char                                      UnknownData_D32C[0x3];                                     // 0x007D(0x0003) MISSED OFFSET (PADDING)
...
struct FSubTrackGroup
{
	...
	unsigned char                                      UnknownData_AZZK[0x7];                                     // 0x0021(0x0007) MISSED OFFSET (PADDING)
...
struct FSupportedSubTrackInfo
{
	...
	unsigned char                                      UnknownData_LLDD[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FSoundTrackKey
{
	...
	unsigned char                                      UnknownData_IY0C[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FToggleTrackKey
{
	...
	unsigned char                                      UnknownData_5G1P[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FVisibilityTrackKey
{
	...
	unsigned char                                      UnknownData_LJZ1[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_AZG2[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IFSR[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FDrawToRenderTargetContext
{
	...
	unsigned char                                      UnknownData_MUC8[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HG13[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FLayerActorStats
{
	...
	unsigned char                                      UnknownData_M5Y3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VL6J[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLevelSimplificationDetails
{
	...
	unsigned char                                      UnknownData_FOHE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TC0A[0x3];                                     // 0x0091(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ITVI[0x2];                                     // 0x012A(0x0002) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_C1KR[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FDynamicTextureInstance : public FStreamableTextureInstance
{
	...
	unsigned char                                      UnknownData_TQ1W[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_ZXJ4[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S6BY[0xC];                                     // 0x00F4(0x000C) MISSED OFFSET (PADDING)
...
struct FBatchedPoint
{
	...
	unsigned char                                      UnknownData_26BQ[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FBatchedLine
{
	...
	unsigned char                                      UnknownData_TAL8[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (PADDING)
...
struct FClientReceiveData
{
	...
	unsigned char                                      UnknownData_M7OF[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParameterGroupData
{
	...
	unsigned char                                      UnknownData_Q1V3[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FMaterialSpriteElement
{
	...
	unsigned char                                      UnknownData_JP04[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BO0L[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMaterialCachedExpressionData
{
	...
	unsigned char                                      UnknownData_A82R[0x7];                                     // 0x0221(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomInput
{
	...
	unsigned char                                      UnknownData_SFZC[0x8];                                     // 0x0014(0x0008) MISSED OFFSET (PADDING)
...
struct FFunctionExpressionInput
{
	...
	unsigned char                                      UnknownData_PMFV[0xC];                                     // 0x0024(0x000C) MISSED OFFSET (PADDING)
...
struct FScalarParameterAtlasInstanceData
{
	...
	unsigned char                                      UnknownData_CWF8[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMemberReference
{
	...
	unsigned char                                      UnknownData_CQUC[0x6];                                     // 0x0032(0x0006) MISSED OFFSET (PADDING)
...
struct FMeshInstancingSettings
{
	...
	unsigned char                                      UnknownData_FHXN[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshReductionSettings
{
	...
	unsigned char                                      UnknownData_I328[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FNavAgentSelector
{
	...
	unsigned char                                      UnknownData_K0FP[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (PADDING)
...
struct FNavigationLinkBase
{
	...
	unsigned char                                      UnknownData_TKKE[0x4];                                     // 0x0008(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0YOZ[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JEJO[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_33PZ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FNodeItem
{
	...
	unsigned char                                      UnknownData_3TR2[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FParticleRandomSeedInfo
{
	...
	unsigned char                                      UnknownData_N3E2[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBeamModifierOptions
{
	...
	unsigned char                                      UnknownData_ZE3W[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData_THLL[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R0P1[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOrbitOptions
{
	...
	unsigned char                                      UnknownData_FPLR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      UnknownData_27EC[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QB1O[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NDE0[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FGPUSpriteResourceData
{
	...
	unsigned char                                      UnknownData_IMBZ[0x2];                                     // 0x0146(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FSOW[0x3];                                     // 0x0151(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_42GB[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (PADDING)
...
struct FGPUSpriteLocalVectorFieldInfo
{
	...
	unsigned char                                      UnknownData_377C[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x0010(0x0030) (IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_OYTN[0x3];                                     // 0x006D(0x0003) MISSED OFFSET (PADDING)
...
struct FGPUSpriteEmitterInfo
{
	...
	unsigned char                                      UnknownData_I9AQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YCMY[0x2];                                     // 0x016A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bEnableCollision : 1;                                      // 0x016C(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_MPIP[0x3];                                     // 0x016D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DUCE[0x3];                                     // 0x0171(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bRemoveHMDRoll : 1;                                        // 0x0174(0x0001) BIT_FIELD (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ZZVW[0x3];                                     // 0x0175(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BZXA[0x10];                                    // 0x0270(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_1DIS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_MVAD[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_YSQL[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6VIA[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IDG4[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (PADDING)
...
struct FPhysicalAnimationData
{
	...
	unsigned char                                      UnknownData_API6[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPhysicalSurfaceName
{
	...
	unsigned char                                      UnknownData_AXVE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FViewTargetTransitionParams
{
	...
	unsigned char                                      UnknownData_L18A[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DQYC[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelVisibilityLevelInfo
{
	...
	unsigned char                                      UnknownData_EA49[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FUpdateLevelStreamingLevelStatus
{
	...
	unsigned char                                      UnknownData_SRRU[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FKeyBind
{
	...
	unsigned char                                      UnknownData_0PJG[0x6];                                     // 0x002A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0XV6[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_19RP[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_RCFC[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HDY3[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_BTLY[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FRigTransformConstraint
{
	...
	unsigned char                                      UnknownData_FWXT[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNode
{
	...
	unsigned char                                      UnknownData_7AWA[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
struct FRootMotionFinishVelocitySettings
{
	...
	unsigned char                                      UnknownData_UZXE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_SOSD[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LR6J[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D4TS[0xD];                                     // 0x0033(0x000D) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8KGS[0x4];                                     // 0x0094(0x0004) Fix Super Size
...
struct FRootMotionSource_JumpForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_AKTV[0x3];                                     // 0x00AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8JZO[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)
...
struct FRootMotionSource_MoveToDynamicForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_VJL8[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_MoveToForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_078O[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_RadialForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_ARG8[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZJA6[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_155N[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FRootMotionSource_ConstantForce : public FRootMotionSource
{
	...
	unsigned char                                      UnknownData_5UFO[0x4];                                     // 0x00A4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FCameraExposureSettings
{
	...
	unsigned char                                      UnknownData_2G37[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8VCZ[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)
...
struct FConvolutionBloomSettings
{
	...
	unsigned char                                      UnknownData_SNYX[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FLensBloomSettings
{
	...
	unsigned char                                      UnknownData_3JS3[0x4];                                     // 0x0084(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EXZ3[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)
...
struct FLensImperfectionSettings
{
	...
	unsigned char                                      UnknownData_6UX9[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FLensSettings
{
	...
	unsigned char                                      UnknownData_2390[0x4];                                     // 0x00DC(0x0004) MISSED OFFSET (PADDING)
...
struct FColorGradingSettings
{
	...
	unsigned char                                      UnknownData_9W0A[0x8];                                     // 0x0148(0x0008) MISSED OFFSET (PADDING)
...
struct FSimpleCurve : public FRealCurve
{
	...
	unsigned char                                      UnknownData_MJF8[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FClothingAssetData_Legacy
{
	...
	unsigned char                                      UnknownData_J0EM[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FClothPhysicsProperties_Legacy              PhysicsProperties;                                         // 0x001C(0x0050) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_FMJ0[0xC];                                     // 0x006C(0x000C) MISSED OFFSET (PADDING)
...
struct FSkeletalMeshClothBuildParams
{
	...
	unsigned char                                      UnknownData_7JE0[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2ONP[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneMirrorExport
{
	...
	unsigned char                                      UnknownData_EILO[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_D6TI[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FBoneFilter
{
	...
	unsigned char                                      UnknownData_BC5N[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSkeletalMeshLODGroupSettings
{
	...
	unsigned char                                      UnknownData_HAIE[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RDGM[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6WK2[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FPrecomputedSkyLightInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_4R1I[0xA4];                                    // 0x00BC(0x00A4) MISSED OFFSET (PADDING)

};

// ScriptStruct Engine.SkylightCubemapCacheEntry
// 0x0010
struct FSkylightCubemapCacheEntry
{
	class UTextureCube*                                Cubemap;                                                   // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_1672[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_3TVH[0x70];                                    // 0x0000(0x0070) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_R9CY[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FSoundClassProperties
{
	...
	unsigned char                                      UnknownData_KIC4[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E5C2[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RX07[0x20];                                    // 0x0038(0x0020) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_7L1T[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9B28[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FSourceEffectChainEntry
{
	...
	unsigned char                                      UnknownData_D8NN[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FSoundGroup
{
	...
	unsigned char                                      UnknownData_P77Y[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0UG4[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSoundClassAdjuster
{
	...
	unsigned char                                      UnknownData_3FY0[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XVO6[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DK44[0x8];                                     // 0x0008(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FModulatorContinuousParams
{
	...
	unsigned char                                      UnknownData_DH32[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FSoundWaveSpectralDataPerSound
{
	...
	unsigned char                                      UnknownData_VL01[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_05T0[0x20];                                    // 0x0000(0x0020) MISSED OFFSET (PADDING)
...
struct FSplineInstanceData : public FSceneComponentInstanceData
{
	...
	unsigned char                                      UnknownData_9QFR[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSplinePoint
{
	...
	unsigned char                                      UnknownData_B2LN[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (PADDING)
...
struct FMaterialRemapIndex
{
	...
	unsigned char                                      UnknownData_Y2WI[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMaterial
{
	...
	unsigned char                                      UnknownData_AKY6[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FAssetEditorOrbitCameraPosition
{
	...
	unsigned char                                      UnknownData_CWAA[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMeshSectionInfo
{
	...
	unsigned char                                      UnknownData_VCFQ[0x1];                                     // 0x0007(0x0001) MISSED OFFSET (PADDING)
...
struct FStaticMeshSourceModel
{
	...
	unsigned char                                      UnknownData_IRJ9[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FStaticMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownData_9TD1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HNSR[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IO1T[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FStaticMeshVertexColorLODData
{
	...
	unsigned char                                      UnknownData_3Y3W[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FStaticMeshComponentInstanceData : public FPrimitiveComponentInstanceData
{
	...
	unsigned char                                      UnknownData_AOUS[0x8];                                     // 0x0128(0x0008) MISSED OFFSET (PADDING)
...
{
	float                                              Time;                                                      // 0x0000(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Y2W2[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_XFTT[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WIRZ[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FStreamingRenderAssetPrimitiveInfo
{
	...
	unsigned char                                      UnknownData_2W5G[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FTimeStretchCurveInstance
{
	...
	unsigned char                                      UnknownData_0RNR[0x2F];                                    // 0x0001(0x002F) MISSED OFFSET (PADDING)
...
struct FVirtualTextureSpacePoolConfig
{
	...
	unsigned char                                      UnknownData_754R[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_F3TH[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FEVM[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FLevelViewportInfo
{
	...
	unsigned char                                      UnknownData_3NJD[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      UnknownData_UZX0[0x2];                                     // 0x0026(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

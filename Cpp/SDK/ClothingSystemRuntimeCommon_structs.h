...
struct FClothLODDataCommon
{
	...
	unsigned char                                      UnknownData_I14T[0x20];                                    // 0x0138(0x0020) MISSED OFFSET (PADDING)
...
struct FClothParameterMask_Legacy
{
	...
	unsigned char                                      UnknownData_YSZU[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3NNG[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MXGR[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
struct FClothConfig_Legacy
{
	...
	unsigned char                                      UnknownData_VQNE[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VKDK[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
// BlueprintGeneratedClass BP_Base_SportFishingBoat_.BP_Base_SportFishingBoat__C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_SportFishingBoat_.BP_Base_SportFishingBoat__C");
		return ptr;
	}

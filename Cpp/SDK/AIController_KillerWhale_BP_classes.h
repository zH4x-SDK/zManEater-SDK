...
// BlueprintGeneratedClass AIController_KillerWhale_BP.AIController_KillerWhale_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_KillerWhale_BP.AIController_KillerWhale_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_KillerWhale_BP(int EntryPoint);
};

...
// BlueprintGeneratedClass BP_Seagulls_Circling_PS.BP_Seagulls_Circling_PS_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Seagulls_Circling_PS.BP_Seagulls_Circling_PS_C");
		return ptr;
	}

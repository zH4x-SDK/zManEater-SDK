...
// BlueprintGeneratedClass BP_Base_BarrelRaft.BP_Base_BarrelRaft_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_BarrelRaft.BP_Base_BarrelRaft_C");
		return ptr;
	}

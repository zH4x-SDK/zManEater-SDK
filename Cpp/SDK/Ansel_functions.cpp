...
void UAnselFunctionLibrary::STATIC_SetUIControlVisibility(class UObject* WorldContextObject, TEnumAsByte<Ansel_EUIControlEffectTarget> UIControlTarget, bool bIsVisible)
{

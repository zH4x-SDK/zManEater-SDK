...
// Function BP_PlayerShark_Jaws_IR.BP_PlayerShark_Jaws_IR_C.GetDirectImpactEffects
...
void UBP_PlayerShark_Jaws_IR_C::GetDirectImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactedSurface, bool bUnderwater, struct FImpactEffect* ImpactEffects)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PlayerShark_Jaws_IR.BP_PlayerShark_Jaws_IR_C.GetDirectImpactEffects");

	UBP_PlayerShark_Jaws_IR_C_GetDirectImpactEffects_Params params;

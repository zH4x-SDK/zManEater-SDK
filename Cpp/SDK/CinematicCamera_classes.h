...
public:
	...
	unsigned char                                      UnknownData_Z55A[0x2];                                     // 0x022E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_Y4BC[0x3];                                     // 0x0225(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
// 0x0060 (FullSize[0x07F0] - InheritedSize[0x0790])
...
public:
	...
	unsigned char                                      UnknownData_W6DE[0x10];                                    // 0x07E0(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      bUseVerticalFOV : 1;                                       // 0x0844(0x0001) BIT_FIELD (Edit, BlueprintVisible, Interp, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OLVU[0xB];                                     // 0x0845(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CXA2[0x8];                                     // 0x08A8(0x0008) MISSED OFFSET (PADDING)

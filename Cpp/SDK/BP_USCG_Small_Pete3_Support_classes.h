...
// BlueprintGeneratedClass BP_USCG_Small_Pete3_Support.BP_USCG_Small_Pete3_Support_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_USCG_Small_Pete3_Support.BP_USCG_Small_Pete3_Support_C");
		return ptr;
	}
	...
	void MoveToSafeLoc();
	void ExecuteUbergraph_BP_USCG_Small_Pete3_Support(int EntryPoint);
};

...
// BlueprintGeneratedClass BP_APEX_LG_Thrash_IR.BP_APEX_LG_Thrash_IR_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_APEX_LG_Thrash_IR.BP_APEX_LG_Thrash_IR_C");
		return ptr;
	}

...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_J4QD[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2SK3[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FEventReply
{
	unsigned char                                      UnknownData_9FR4[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W57I[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FMovieScene2DTransformSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_W6O1[0x3];                                     // 0x04A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_JPAD[0x7];                                     // 0x02C9(0x0007) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_CNC1[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_0KZ4[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_E6EB[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_43U8[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_PQVY[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_T34A[0x10];                                    // 0x00A8(0x0010) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_9JF1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

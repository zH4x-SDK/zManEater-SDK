...
// BlueprintGeneratedClass FSH_MahiMahi_Med_BP.FSH_MahiMahi_Med_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass FSH_MahiMahi_Med_BP.FSH_MahiMahi_Med_BP_C");
		return ptr;
	}

...
// BlueprintGeneratedClass AIController_HammerHead_BP.AIController_HammerHead_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_HammerHead_BP.AIController_HammerHead_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_HammerHead_BP(int EntryPoint);
};

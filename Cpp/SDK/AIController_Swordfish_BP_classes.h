...
// BlueprintGeneratedClass AIController_Swordfish_BP.AIController_Swordfish_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_Swordfish_BP.AIController_Swordfish_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_Swordfish_BP(int EntryPoint);
};

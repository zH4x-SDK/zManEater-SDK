...
// BlueprintGeneratedClass BP_Base_USCG_Medium_Bounty.BP_Base_USCG_Medium_Bounty_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_USCG_Medium_Bounty.BP_Base_USCG_Medium_Bounty_C");
		return ptr;
	}

...
// BlueprintGeneratedClass AIController_SpermWhale_BP.AIController_SpermWhale_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_SpermWhale_BP.AIController_SpermWhale_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_SpermWhale_BP(int EntryPoint);
};

...
// BlueprintGeneratedClass BP_DepthChargeBarrel_Base.BP_DepthChargeBarrel_Base_C
...
public:
	...
	float                                              MaterialTimeline_Active_2FF683944219DBE3B4A6DAB91BF5BDBC;  // 0x03C8(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                              MaterialTimeline_FlashSpeed_2FF683944219DBE3B4A6DAB91BF5BDBC; // 0x03CC(0x0004) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TEnumAsByte<Engine_ETimelineDirection>             MaterialTimeline__Direction_2FF683944219DBE3B4A6DAB91BF5BDBC; // 0x03D0(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	unsigned char                                      UnknownData_7JN1[0x7];                                     // 0x03D1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_DepthChargeBarrel_Base.BP_DepthChargeBarrel_Base_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_DepthChargeBarrel_Base(int EntryPoint);
};

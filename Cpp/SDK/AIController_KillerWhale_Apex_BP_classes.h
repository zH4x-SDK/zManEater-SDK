...
// BlueprintGeneratedClass AIController_KillerWhale_Apex_BP.AIController_KillerWhale_Apex_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_KillerWhale_Apex_BP.AIController_KillerWhale_Apex_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_KillerWhale_Apex_BP(int EntryPoint);
};

...
// BlueprintGeneratedClass AIController_Mako_Apex_BP.AIController_Mako_Apex_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_Mako_Apex_BP.AIController_Mako_Apex_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_Mako_Apex_BP(int EntryPoint);
};

...
// BlueprintGeneratedClass BP_Sailboat_Boom.BP_Sailboat_Boom_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Sailboat_Boom.BP_Sailboat_Boom_C");
		return ptr;
	}

...
struct FInputRayHit
{
	unsigned char                                      UnknownData_RS91[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RPUO[0xA8];                                    // 0x0000(0x00A8) MISSED OFFSET (PADDING)
...
struct FBehaviorInfo
{
	...
	unsigned char                                      UnknownData_550X[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveGizmo
{
	unsigned char                                      UnknownData_LXEI[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)

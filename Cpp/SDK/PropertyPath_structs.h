...
struct FPropertyPathSegment
{
	...
	unsigned char                                      UnknownData_1Z99[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ICCA[0x10];                                    // 0x0018(0x0010) MISSED OFFSET (PADDING)
...
struct FCachedPropertyPath
{
	...
	unsigned char                                      UnknownData_Y93T[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_22FC[0x8];                                     // 0x0020(0x0008) MISSED OFFSET (PADDING)

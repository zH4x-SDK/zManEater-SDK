...
// Function BP_PlayerSharkThrash_IR.BP_PlayerSharkThrash_IR_C.GetImpactEffects
...
struct FImpactEffect UBP_PlayerSharkThrash_IR_C::GetImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactingSurface, bool bUnderwater, bool bScrape)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PlayerSharkThrash_IR.BP_PlayerSharkThrash_IR_C.GetImpactEffects");

	UBP_PlayerSharkThrash_IR_C_GetImpactEffects_Params params;
...
// Function BP_PlayerSharkThrash_IR.BP_PlayerSharkThrash_IR_C.GetDirectImpactEffects
...
void UBP_PlayerSharkThrash_IR_C::GetDirectImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactedSurface, bool bUnderwater, struct FImpactEffect* ImpactEffects)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_PlayerSharkThrash_IR.BP_PlayerSharkThrash_IR_C.GetDirectImpactEffects");

	UBP_PlayerSharkThrash_IR_C_GetDirectImpactEffects_Params params;

...
// BlueprintGeneratedClass BP_Base_TourAirboat.BP_Base_TourAirboat_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_TourAirboat.BP_Base_TourAirboat_C");
		return ptr;
	}

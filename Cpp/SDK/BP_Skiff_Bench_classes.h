...
// BlueprintGeneratedClass BP_Skiff_Bench.BP_Skiff_Bench_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Skiff_Bench.BP_Skiff_Bench_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Skiff_Bench(int EntryPoint);
};

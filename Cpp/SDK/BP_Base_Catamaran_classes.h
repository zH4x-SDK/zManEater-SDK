...
// BlueprintGeneratedClass BP_Base_Catamaran.BP_Base_Catamaran_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_Catamaran.BP_Base_Catamaran_C");
		return ptr;
	}

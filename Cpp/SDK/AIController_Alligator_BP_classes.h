...
// BlueprintGeneratedClass AIController_Alligator_BP.AIController_Alligator_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_Alligator_BP.AIController_Alligator_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_Alligator_BP(int EntryPoint);
};

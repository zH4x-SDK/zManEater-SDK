...
struct FDatasmithImportBaseOptions
{
	...
	unsigned char                                      UnknownData_5K1V[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithTessellationOptions
{
	...
	unsigned char                                      UnknownData_1BU5[0x3];                                     // 0x000D(0x0003) MISSED OFFSET (PADDING)
...
struct FDatasmithMeshBuildSettingsTemplate
{
	...
	unsigned char                                      UnknownData_1T7F[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithCameraLookatTrackingSettingsTemplate
{
	...
	unsigned char                                      UnknownData_KLJW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithCameraFocusSettingsTemplate
{
	...
	unsigned char                                      UnknownData_I6K9[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDatasmithPostProcessSettingsTemplate
{
	...
	unsigned char                                      UnknownData_U2M4[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8WV6[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_E87P[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

...
// BlueprintGeneratedClass BP_Base_Superyacht.BP_Base_Superyacht_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_Superyacht.BP_Base_Superyacht_C");
		return ptr;
	}

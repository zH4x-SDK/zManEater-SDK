...
// BlueprintGeneratedClass BP_HumanFlesh_IR.BP_HumanFlesh_IR_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_HumanFlesh_IR.BP_HumanFlesh_IR_C");
		return ptr;
	}

...
// BlueprintGeneratedClass AIController_Apex_Barracuda_BP.AIController_Apex_Barracuda_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_Apex_Barracuda_BP.AIController_Apex_Barracuda_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_Apex_Barracuda_BP(int EntryPoint);
};

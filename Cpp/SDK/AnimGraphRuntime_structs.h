...
struct FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_MRGW[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CUR7[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_INFY[0x3C];                                    // 0x00E8(0x003C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_URXV[0x3];                                     // 0x0125(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JXP2[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J6TY[0x2];                                     // 0x0116(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_65O3[0x34];                                    // 0x022C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwistCorrectiveNode : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_FDHB[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_I4NE[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_H68A[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FBoneSocketTarget
{
	...
	unsigned char                                      UnknownData_ORWO[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBoneReference                              BoneReference;                                             // 0x0004(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_YF3E[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_1ESU[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MK24[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8PIA[0xD];                                     // 0x01D3(0x000D) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_K5QC : 2;                                      // 0x0031(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_SKWK[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9JLN[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_8OHO[0x250];                                   // 0x06E0(0x0250) MISSED OFFSET (PADDING)
...
struct FPositionHistory
{
	...
	unsigned char                                      UnknownData_U08Z[0x1C];                                    // 0x0014(0x001C) MISSED OFFSET (PADDING)
...
struct FRBFTarget : public FRBFEntry
{
	...
	unsigned char                                      UnknownData_ZH6Q[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0NQU[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_X3J5[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FIKChain
{
	unsigned char                                      UnknownData_GALM[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FIKChainLink
{
	unsigned char                                      UnknownData_H88I[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_Z1W4[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q6C2[0x2];                                     // 0x015E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KZUD[0x34];                                    // 0x017C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_MakeDynamicAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_8M0Y[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_B7K0[0x6];                                     // 0x0102(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyCurve : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_HH7P[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_03G4[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_MultiWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_1R7I[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P9Y0[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_ZS8T[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_SH0Q[0x40];                                    // 0x0038(0x0040) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseBlendNode : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_N5XH[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseByName : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_TNBV[0xC];                                     // 0x0084(0x000C) MISSED OFFSET (PADDING)
...
struct FPoseDriverTarget
{
	...
	unsigned char                                      UnknownData_LHSS[0x5];                                     // 0x0023(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2R90[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8MRN[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
...
struct FRBFParams
{
	...
	unsigned char                                      UnknownData_LWHE[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JZY6[0x1];                                     // 0x000F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WPAY[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_4XQB[0x30];                                    // 0x00B8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NKX4[0x1];                                     // 0x0127(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseSnapshot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_MEO4[0x3F];                                    // 0x0051(0x003F) MISSED OFFSET (PADDING)
...
struct FRandomPlayerSequenceEntry
{
	...
	unsigned char                                      UnknownData_ZMAV[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_RandomPlayer : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_H421[0x50];                                    // 0x0020(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SN1M[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_RefPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ZZJV[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IXSL[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_USX0[0x98];                                    // 0x00D0(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GAKA[0x1];                                     // 0x01BB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4ZTA[0x3];                                     // 0x01BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSolverIterations                           OverrideSolverIterations;                                  // 0x01C0(0x0018) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_SKVA[0x3B8];                                   // 0x01D8(0x03B8) MISSED OFFSET (PADDING)
...
struct FAnimNode_RigidBody_Chaos : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_OI1T[0x444];                                   // 0x013C(0x0444) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotateRootBone : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_UL8O[0xC];                                     // 0x0094(0x000C) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_96TF[0x2];                                     // 0x00EE(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_NUWT[0x2];                                     // 0x0042(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ESJI[0x88];                                    // 0x0050(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_E2EV[0x4];                                     // 0x0180(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6JTX[0x2];                                     // 0x0186(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TFUN[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_S5M4[0x17];                                    // 0x0061(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_FQW4[0x1];                                     // 0x003F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X31E[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_Slot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_2XRF[0x1F];                                    // 0x0029(0x001F) MISSED OFFSET (PADDING)
...
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_I1OT[0x2];                                     // 0x00EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WWV5[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XP3F[0x118];                                   // 0x0148(0x0118) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_KI4Z[0x60];                                    // 0x00E0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AU6O[0x30];                                    // 0x0180(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimPhysConstraintSetup
{
	...
	unsigned char                                      UnknownData_KWXA[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TPY9[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimPhysSphericalLimit
{
	...
	unsigned char                                      UnknownData_UIWX[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FRotationRetargetingInfo
{
	...
	unsigned char                                      UnknownData_9832[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WU4R[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BU6D[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L316[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EEB9[0x3];                                     // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JWE2[0x7];                                     // 0x0129(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_TZG4[0x60];                                    // 0x00D0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_64SM[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FTY4[0x2];                                     // 0x0242(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7AAF : 1;                                      // 0x0245(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_SD2V[0xA];                                     // 0x0246(0x000A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRotationRetargetingInfo                    RetargetingSettings;                                       // 0x0250(0x0130) (Edit, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JX8Z[0xC0];                                    // 0x0380(0x00C0) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	struct FName                                       AlphaCurveName;                                            // 0x0088(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                       // 0x0090(0x0030) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_6XOS[0x4];                                     // 0x00C0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YO3N[0x2];                                     // 0x00C6(0x0002) MISSED OFFSET (PADDING)
...
struct FBlendBoneByChannelEntry
{
	...
	unsigned char                                      UnknownData_TEP5[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendBoneByChannel : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ZK39[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_ZKPK[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HMOB[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_H325[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I836[0x50];                                    // 0x0048(0x0050) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_SP8I[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByEnum : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_KXAH[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByInt : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_TQ5P[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpaceEvaluator : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_ZNFJ[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_H3R0[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_CCDIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_Q6RK[0xB];                                     // 0x00D5(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LHAT[0x6];                                     // 0x016A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FConstraint
{
	...
	unsigned char                                      UnknownData_ZA9W[0x7];                                     // 0x0015(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_Constraint : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_9VEF[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_4D6S[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_SE76[0x126];                                   // 0x001A(0x0126) MISSED OFFSET (PADDING)
...
struct FAnimNode_CurveSource : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ILSH[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_1FMV[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VE7W[0x6];                                     // 0x018A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_HandIKRetargeting : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_WGFA[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_RHGN[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PF20[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Y1AZ[0x30];                                    // 0x0090(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimNode_LegIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_ER3R[0x18];                                    // 0x00E0(0x0018) MISSED OFFSET (PADDING)

...
// BlueprintGeneratedClass BP_Base_FishingTrawler_Empty.BP_Base_FishingTrawler_Empty_C
...
public:
	...
	float                                              LastHitTime;                                               // 0x0C00(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_FishingTrawler_Empty.BP_Base_FishingTrawler_Empty_C");
		return ptr;
	}

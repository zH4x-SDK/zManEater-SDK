...
struct FAIStimulus
{
	...
	unsigned char                                      UnknownData_OPJU[0xC];                                     // 0x002C(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      UnknownData_SJCM : 1;                                      // 0x0038(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_PXG8[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_J8UY[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAIDataProviderTypedValue : public FAIDataProviderValue
{
	...
	unsigned char                                      UnknownData_Q1C6[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FAIDataProviderIntValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_7S9K[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_DFIF[0x10];                                    // 0x0020(0x0010) MISSED OFFSET (PADDING)
...
struct FActorPerceptionBlueprintInfo
{
	...
	unsigned char                                      UnknownData_1EKW[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FAISenseAffiliationFilter
{
	...
	unsigned char                                      UnknownData_0TSK[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EIZH[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_RFGF[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FIntervalCountdown
{
	...
	unsigned char                                      UnknownData_NNE8[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (PADDING)
...
struct FAIMoveRequest
{
	...
	unsigned char                                      UnknownData_YRRR[0x38];                                    // 0x0008(0x0038) MISSED OFFSET (PADDING)
...
struct FBehaviorTreeTemplateInfo
{
	...
	unsigned char                                      UnknownData_XYT9[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FBlackboardEntry
{
	...
	unsigned char                                      UnknownData_S1WS[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FEnvQueryInstanceCache
{
	...
	unsigned char                                      UnknownData_7AM5[0x170];                                   // 0x0008(0x0170) MISSED OFFSET (PADDING)
...
struct FEnvQueryRequest
{
	...
	unsigned char                                      UnknownData_ABHK[0x50];                                    // 0x0018(0x0050) MISSED OFFSET (PADDING)
...
struct FBlackboardKeySelector
{
	...
	unsigned char                                      UnknownData_OG6Z[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8FWN[0x3];                                     // 0x0025(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDynamicParam
{
	...
	unsigned char                                      UnknownData_SSLG[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	unsigned char                                      UnknownData_GZX2[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XBM0[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_WFZ4[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8T65[0x14];                                    // 0x0018(0x0014) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4ZXB[0xC];                                     // 0x0034(0x000C) MISSED OFFSET (PADDING)
...
struct FEnvOverlapData
{
	...
	unsigned char                                      UnknownData_T7RA[0x2];                                     // 0x001A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6O3B[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FEnvDirection
{
	...
	unsigned char                                      UnknownData_Z511[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FPawnActionEvent
{
	...
	unsigned char                                      UnknownData_KDVI[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
struct FBTDecoratorLogic
{
	...
	unsigned char                                      UnknownData_Y9L0[0x1];                                     // 0x0001(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FEnvTraceData
{
	...
	unsigned char                                      UnknownData_EJD8[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C1Q8[0x3];                                     // 0x002D(0x0003) MISSED OFFSET (PADDING)
...
struct FAIDataProviderFloatValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_R067[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)
...
struct FAIDataProviderBoolValue : public FAIDataProviderTypedValue
{
	...
	unsigned char                                      UnknownData_AI8Z[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FEnvNamedValue
{
	...
	unsigned char                                      UnknownData_6JE6[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Value;                                                     // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FAIDamageEvent
{
	...
	unsigned char                                      UnknownData_NTFQ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_M215[0x4];                                     // 0x0000(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QD3U[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FAIPredictionEvent
{
	...
	unsigned char                                      UnknownData_Z5XT[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P3Q2[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)

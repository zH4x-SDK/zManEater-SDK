...
struct FNamedFilmbackPreset
{
	...
	unsigned char                                      UnknownData_9CKJ[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FCameraLookatTrackingSettings
{
	...
	unsigned char                                      UnknownData_28VQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JDRK[0x10];                                    // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CRW3[0x3];                                     // 0x004D(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraTrackingFocusSettings
{
	...
	unsigned char                                      UnknownData_3GXF[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (PADDING)
...
struct FCameraFocusSettings
{
	...
	unsigned char                                      UnknownData_3SLI[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FG5S[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HV44[0x3];                                     // 0x0049(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1W8W[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)

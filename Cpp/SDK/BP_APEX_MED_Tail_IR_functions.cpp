...
// Function BP_APEX_MED_Tail_IR.BP_APEX_MED_Tail_IR_C.GetImpactEffects
...
struct FImpactEffect UBP_APEX_MED_Tail_IR_C::GetImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactingSurface, bool bUnderwater, bool bScrape)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_APEX_MED_Tail_IR.BP_APEX_MED_Tail_IR_C.GetImpactEffects");

	UBP_APEX_MED_Tail_IR_C_GetImpactEffects_Params params;

...
struct FMovieSceneSequenceReplProperties
{
	...
	unsigned char                                      UnknownData_62VM[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSpawnable
{
	...
	unsigned char                                      UnknownData_XVL5[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7FZM[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L7LG[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_89WQ[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_W67K[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvalTemplate : public FMovieSceneEvalTemplateBase
{
	...
	unsigned char                                      UnknownData_RJ34[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PVR0[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneTrackDisplayOptions
{
	...
	unsigned char                                      UnknownData_V1Z1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectBindingID
{
	...
	unsigned char                                      UnknownData_YQ5V[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneMarkedFrame
{
	...
	unsigned char                                      UnknownData_M738[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneBindingOverrideData
{
	...
	unsigned char                                      UnknownData_66Z9[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_2UTC[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneByteChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_BL8X[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DU1L[0x60];                                    // 0x0038(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZBQN[0x88];                                    // 0x0000(0x0088) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ZKLB[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SDZG[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SQHI[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IBBP[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneTemplateGenerationLedger
{
	...
	unsigned char                                      UnknownData_809A[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSubSectionData
{
	...
	unsigned char                                      UnknownData_PAA6[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RQN0[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FMovieSceneSequenceID, class UObject*> DirectorInstances;                                         // 0x0018(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_INM7[0x2B8];                                   // 0x0068(0x02B8) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_HCJU[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)
...
struct FMovieSceneKeyTimeStruct : public FMovieSceneKeyStruct
{
	...
	unsigned char                                      UnknownData_XE7F[0x1C];                                    // 0x000C(0x001C) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_VE2O[0x50];                                    // 0x0000(0x0050) MISSED OFFSET (PADDING)
...
struct FMovieSceneObjectPathChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_RJ4J[0x60];                                    // 0x0060(0x0060) MISSED OFFSET (PADDING)
...
struct FSectionEvaluationData
{
	...
	unsigned char                                      UnknownData_EN3P[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneEasingSettings
{
	...
	unsigned char                                      UnknownData_CGRR[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ELIG[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneTrackEvalOptions
{
	...
	unsigned char                                      UnknownData_RZO7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_0TOE[0x58];                                    // 0x0000(0x0058) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_OHOU[0x60];                                    // 0x0000(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_APMZ[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      UnknownData_PPNQ[0x5];                                     // 0x0013(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SFRG[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (PADDING)
...
{
	struct FMovieSceneTimeTransform                    LinearTransform;                                           // 0x0000(0x000C) (NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_JSX3[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_F2ND[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
...
struct FMovieSceneSubSequenceData
{
	...
	unsigned char                                      UnknownData_JXHU[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequenceHierarchyNode
{
	...
	unsigned char                                      UnknownData_Y26K[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneEvaluationTemplate
{
	...
	unsigned char                                      UnknownData_3M46[0x50];                                    // 0x0050(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5OYD[0x4];                                     // 0x0184(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneSequencePlaybackSettings
{
	...
	unsigned char                                      UnknownData_VGCR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_163M[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneSectionParameters
{
	...
	unsigned char                                      UnknownData_19S9[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
	...
	bool                                               bHasDefaultValue;                                          // 0x0019(0x0001) (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_R5OG[0x6];                                     // 0x001A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<bool>                                       Values;                                                    // 0x0020(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_NXCU[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
struct FMovieSceneTangentData
{
	...
	unsigned char                                      UnknownData_N3Y2[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatValue
{
	...
	unsigned char                                      UnknownData_X3B0[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (PADDING)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_OWWF[0x6];                                     // 0x000A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FFrameNumber>                        Times;                                                     // 0x0010(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	unsigned char                                      UnknownData_W2WM[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      UnknownData_WHPY[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<int>                                        Values;                                                    // 0x0020(0x0010) (ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_3T8H[0x60];                                    // 0x0030(0x0060) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_A8HD[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (PADDING)

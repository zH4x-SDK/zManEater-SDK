...
// BlueprintGeneratedClass AIController_Barracuda_BP.AIController_Barracuda_BP_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass AIController_Barracuda_BP.AIController_Barracuda_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_AIController_Barracuda_BP(int EntryPoint);
};

...
// Function BP_Bullet_IR.BP_Bullet_IR_C.GetDirectImpactEffects
...
void UBP_Bullet_IR_C::GetDirectImpactEffects(TEnumAsByte<Engine_EPhysicalSurface> ImpactedSurface, bool bUnderwater, struct FImpactEffect* ImpactEffects)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Bullet_IR.BP_Bullet_IR_C.GetDirectImpactEffects");

	UBP_Bullet_IR_C_GetDirectImpactEffects_Params params;

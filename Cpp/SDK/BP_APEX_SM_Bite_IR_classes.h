...
// BlueprintGeneratedClass BP_APEX_SM_Bite_IR.BP_APEX_SM_Bite_IR_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_APEX_SM_Bite_IR.BP_APEX_SM_Bite_IR_C");
		return ptr;
	}

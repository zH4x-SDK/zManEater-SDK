...
// BlueprintGeneratedClass BP_PlayerShark_Slam_IR.BP_PlayerShark_Slam_IR_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_PlayerShark_Slam_IR.BP_PlayerShark_Slam_IR_C");
		return ptr;
	}

...
struct FWheelSetup
{
	...
	unsigned char                                      UnknownData_BJTI[0x3];                                     // 0x001D(0x0003) MISSED OFFSET (PADDING)
...
struct FVehicleTransmissionData
{
	...
	unsigned char                                      UnknownData_18TZ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9LWP[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleEngineData
{
	...
	unsigned char                                      UnknownData_NLUI[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FVehicleDifferential4WData
{
	...
	unsigned char                                      UnknownData_LBHS[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FTireConfigMaterialFriction
{
	...
	unsigned char                                      UnknownData_FEFR[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TXF8[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9AAK[0x10];                                    // 0x06E0(0x0010) MISSED OFFSET (PADDING)

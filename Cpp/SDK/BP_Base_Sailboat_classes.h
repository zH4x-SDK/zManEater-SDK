...
// BlueprintGeneratedClass BP_Base_Sailboat.BP_Base_Sailboat_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Base_Sailboat.BP_Base_Sailboat_C");
		return ptr;
	}
